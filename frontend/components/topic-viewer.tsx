  ...
  return (
    <div className="space-y-12 max-w-3xl">
      ...
      <Tabs defaultValue="explain" className="w-full max-w-3xl">
        ...
        <TabsContent value="explain" className="space-y-4 mt-8 w-full">
        ...
        <TabsContent value="code" className="space-y-4 mt-8 w-full">
        ...
        <TabsContent value="usecases" className="space-y-4 mt-8 w-full">
